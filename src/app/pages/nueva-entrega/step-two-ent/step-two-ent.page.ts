...
@Component({
  selector: 'app-step-two-ent',
  templateUrl: './step-two-ent.page.html',
  styleUrls: ['./step-two-ent.page.scss'],
})
export class StepTwoEntPage implements OnInit {

  titulo = "NUEVA ENTREGA 2 - Gestor Destino: Selección";
  myForm: FormGroup;
