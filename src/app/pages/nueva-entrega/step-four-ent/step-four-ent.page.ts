...
@Component({
  selector: 'app-step-four-ent',
  templateUrl: './step-four-ent.page.html',
  styleUrls: ['./step-four-ent.page.scss'],
})
export class StepFourEntPage implements OnInit {

  titulo = "NUEVA ENTREGA 4 - Firma Origen";
  myForm: FormGroup;
