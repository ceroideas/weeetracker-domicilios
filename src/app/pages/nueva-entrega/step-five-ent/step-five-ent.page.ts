...
@Component({
  selector: 'app-step-five-ent',
  templateUrl: './step-five-ent.page.html',
  styleUrls: ['./step-five-ent.page.scss'],
})
export class StepFiveEntPage implements OnInit {

  titulo = "NUEVA ENTREGA 5 - Firma Transportista";
  myForm: FormGroup;
