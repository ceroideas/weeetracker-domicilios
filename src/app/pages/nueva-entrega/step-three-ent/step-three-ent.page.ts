...
@Component({
  selector: 'app-step-three-ent',
  templateUrl: './step-three-ent.page.html',
  styleUrls: ['./step-three-ent.page.scss'],
})
export class StepThreeEntPage implements OnInit {

  titulo = "NUEVA ENTREGA 3 - Tipo Lectura";
  myForm: FormGroup;
