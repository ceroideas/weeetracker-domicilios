...
@Component({
  selector: 'app-step-four-rep',
  templateUrl: './step-four-rep.page.html',
  styleUrls: ['./step-four-rep.page.scss'],
})
export class StepFourRepPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA 4 - Firma Origen";
  myForm: FormGroup;
