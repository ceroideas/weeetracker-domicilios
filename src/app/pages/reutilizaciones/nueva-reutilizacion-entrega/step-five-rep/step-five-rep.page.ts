...
@Component({
  selector: 'app-step-five-rep',
  templateUrl: './step-five-rep.page.html',
  styleUrls: ['./step-five-rep.page.scss'],
})
export class StepFiveRepPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA 5 - Firma Transportista";
  myForm: FormGroup;
