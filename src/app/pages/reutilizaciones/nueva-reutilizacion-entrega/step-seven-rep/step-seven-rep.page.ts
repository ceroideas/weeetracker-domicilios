...
@Component({
  selector: 'app-step-seven-rep',
  templateUrl: './step-seven-rep.page.html',
  styleUrls: ['./step-seven-rep.page.scss'],
  providers: [Geolocation]
})
export class StepSevenRepPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA 6 - Entrega Completada";
  myForm: FormGroup;
