...
@Component({
  selector: 'app-pesar-reutilizaciones',
  templateUrl: './pesar-reutilizaciones.page.html',
  styleUrls: ['./pesar-reutilizaciones.page.scss'],
})
export class PesarReutilizacionesPage implements OnInit {

  titulo: string = "Pesar RAEEs Reutilizaciones";
  ...
  {
    this.certificados = [];
    this.consultasService.RaeesDia2(moment().subtract(this.usuario.direccionTercero.diasPesado,'day').format('Y-MM-DD'),this.idCentro).subscribe((data:any)=>{
      console.log(data);
