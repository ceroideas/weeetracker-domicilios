...
@Component({
  selector: 'app-step-four-rre',
  templateUrl: './step-four-rre.page.html',
  styleUrls: ['./step-four-rre.page.scss'],
})
export class StepFourRrePage implements OnInit {

  titulo = "NUEVA RECOGIDA DE REUTILIZACIÓN 4 - Firma Origen";
  myForm: FormGroup;
