...
@Component({
  selector: 'app-nueva-recogida-reutilizacion',
  templateUrl: './nueva-recogida-reutilizacion.page.html',
  styleUrls: ['./nueva-recogida-reutilizacion.page.scss'],
  providers: [Geolocation]
})
export class NuevaRecogidaReutilizacionPage implements OnInit {

  titulo = "NUEVA RECOGIDA DE REUTILIZACIÓN 0 - Fecha Operación";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-recogida-reutilizacion/step-one-rre');
  }
