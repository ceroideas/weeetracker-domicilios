...
@Component({
  selector: 'app-step-eight-ren',
  templateUrl: './step-eight-ren.page.html',
  styleUrls: ['./step-eight-ren.page.scss'],
  providers: [Geolocation]
})
export class StepEightRenPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA DIRECTA 8 - Entrega Completada";
  myForm: FormGroup;
  ...
  async adelante()
  {
    ...
    let firma_3 = await this._storage.get('firma_destino');
    ...
    firma_3.archivo = 'Fr'+this.myForm.value.certificado+'_13.png';
    ...
    firmas.push({
      PidFirmaCertificado: firma_3.id,
      Firma: firma_3.archivo,
      Nombre: firma_3.nombre,
      Cargo: firma_3.cargo,
    });
