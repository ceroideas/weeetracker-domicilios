...
@Component({
  selector: 'app-step-seven-ren',
  templateUrl: './step-seven-ren.page.html',
  styleUrls: ['./step-seven-ren.page.scss'],
})
export class StepSevenRenPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA DIRECTA 7 - Firma Gestor Destino";
  myForm: FormGroup;
  ...
  async ngOnInit() {
    ...
    this.canvas = document.querySelector("#sign-seven");
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion-entrega-directa/step-eight-ren');
  }
