...
@Component({
  selector: 'app-step-six-ren',
  templateUrl: './step-six-ren.page.html',
  styleUrls: ['./step-six-ren.page.scss'],
})
export class StepSixRenPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA DIRECTA 6 - Firma Transportista";
  myForm: FormGroup;
  ...
  async cargarUsuario()
  {
    ...
    this.myForm.patchValue({gestor_recogida: this.destino.nombre});
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion-entrega-directa/step-seven-ren');
  }
