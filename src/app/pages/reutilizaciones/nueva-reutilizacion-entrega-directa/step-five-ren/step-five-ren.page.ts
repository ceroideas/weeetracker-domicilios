...
@Component({
  selector: 'app-step-five-ren',
  templateUrl: './step-five-ren.page.html',
  styleUrls: ['./step-five-ren.page.scss'],
})
export class StepFiveRenPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA DIRECTA 5 - Firma Origen";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion-entrega-directa/step-six-ren');
  }
