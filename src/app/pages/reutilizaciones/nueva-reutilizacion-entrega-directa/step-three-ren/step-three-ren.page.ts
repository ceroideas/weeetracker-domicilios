...
@Component({
  selector: 'app-step-three-ren',
  templateUrl: './step-three-ren.page.html',
  styleUrls: ['./step-three-ren.page.scss'],
})
export class StepThreeRenPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN ENTREGA DIRECTA 3 - Gestor Destino: Selección";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion-entrega-directa/step-four-ren')
  }
