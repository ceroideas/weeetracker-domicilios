...
@Component({
  selector: 'app-reutilizaciones-realizadas',
  templateUrl: './reutilizaciones-realizadas.page.html',
  styleUrls: ['./reutilizaciones-realizadas.page.scss'],
})
export class ReutilizacionesRealizadasPage implements OnInit {

  titulo: string = "Reutilizaciones Realizadas";
  ...
  {
    await this.usuarioService.mostrarSpinner("Obteniendo Reutilizaciones");
    this.consultasService.getReutilizaciones(this.idTercero, this.idCentro).subscribe((res: any) => {
      console.log(res);
