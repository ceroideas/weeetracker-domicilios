...
@Component({
  selector: 'app-step-four-reu',
  templateUrl: './step-four-reu.page.html',
  styleUrls: ['./step-four-reu.page.scss'],
})
export class StepFourReuPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN 4 - Firma Origen";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion/step-five-reu');
  }
