...
@Component({
  selector: 'app-step-five-reu',
  templateUrl: './step-five-reu.page.html',
  styleUrls: ['./step-five-reu.page.scss'],
})
export class StepFiveReuPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN 5 - Firma Transportista";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/reutilizaciones/nueva-reutilizacion/step-six-reu');
  }
