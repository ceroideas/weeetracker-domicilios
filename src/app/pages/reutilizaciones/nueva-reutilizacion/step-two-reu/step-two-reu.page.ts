...
@Component({
  ...
  templateUrl: './step-two-reu.page.html',
  styleUrls: ['./step-two-reu.page.scss'],
})
export class StepTwoReuPage implements OnInit {

  titulo = "NUEVA REUTILIZACIÓN 2 - Origen Residuo";
  myForm: FormGroup;
  ...
  sendToSearch2(id)
  {
    ...
    this.loadingCtrl.create({message: "Obteniendo información de centro..."}).then(l=>{
      ...
      this.consultaService.centroData(id,this.usuario.tercero.PidTercero,this.usuario.dtercero,'REU').subscribe((data:any)=>{
