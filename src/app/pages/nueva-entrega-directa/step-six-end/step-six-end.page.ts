...
@Component({
  selector: 'app-step-six-end',
  templateUrl: './step-six-end.page.html',
  styleUrls: ['./step-six-end.page.scss'],
})
export class StepSixEndPage implements OnInit {

  titulo = "NUEVA ENTREGA DIRECTA 6 - Firma Transportista";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/nueva-entrega-directa/step-seven-end');
  }
