...
@Component({
  selector: 'app-step-four-end',
  templateUrl: './step-four-end.page.html',
  styleUrls: ['./step-four-end.page.scss'],
})
export class StepFourEndPage implements OnInit {

  titulo = "NUEVA ENTREGA DIRECTA 4 - Tipo Lectura";
  myForm: FormGroup;
