...
@Component({
  selector: 'app-step-seven-end',
  templateUrl: './step-seven-end.page.html',
  styleUrls: ['./step-seven-end.page.scss'],
})
export class StepSevenEndPage implements OnInit {

  titulo = "NUEVA ENTREGA DIRECTA 7 - Firma Gestor Destino";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/nueva-entrega-directa/step-eight-end');
  }
