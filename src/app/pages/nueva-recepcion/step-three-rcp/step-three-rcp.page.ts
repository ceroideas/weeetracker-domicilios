...
@Component({
  selector: 'app-step-three-rcp',
  templateUrl: './step-three-rcp.page.html',
  styleUrls: ['./step-three-rcp.page.scss'],
})
export class StepThreeRcpPage implements OnInit {

  titulo = "NUEVA RECEPCIÓN 3 - Tipo Lectura";
  myForm: FormGroup;
