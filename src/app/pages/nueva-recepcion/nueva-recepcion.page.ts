...
@Component({
  ...
  templateUrl: './nueva-recepcion.page.html',
  styleUrls: ['./nueva-recepcion.page.scss'],
  providers: [Geolocation]
})
export class NuevaRecepcionPage implements OnInit {

  titulo = "NUEVA RECEPCIÓN 0 - Fecha Operación";
  myForm: FormGroup;
  ...
  adelante()
  {
    ...
    this.nav.navigateForward('/nueva-recepcion/step-one-rcp');
  }
