...
@Component({
  selector: 'app-step-five-rcp',
  templateUrl: './step-five-rcp.page.html',
  styleUrls: ['./step-five-rcp.page.scss'],
})
export class StepFiveRcpPage implements OnInit {

  titulo = "NUEVA RECEPCIÓN 5 - Firma Transportista";
  myForm: FormGroup;
