...
export class ConsultasService {
  ...
  getConsultaResiduoUsuario(idUsuario, idCentro, idResiduo) {
    return this.http.get(apiUrl + '/residuo/especifico-usuario/'+idUsuario+'/'+idCentro+'/'+idResiduo);
  }
  ...
  getStockUsuario(idUsuario,idCentro) {
    return this.http.get(apiUrl + '/stock/stock-usuario/'+idUsuario+'/'+idCentro);
  }
  ...
  consultaSolicitudes(idTercero, idCentro, estado){
    let solicitud = { idTercero : idTercero , idCentro : idCentro, Estado : estado};
